...
const IcoImageUpload = ({maxCount, maxSize,accept, imageList, onImageUploadChange}) => {
    ...
    const props = {
        name: 'my-file',
        action: process.env.NEXT_PUBLIC_BASE_URL + '/myapp/admin/cdn/uploadIcoImg',
        headers: {
