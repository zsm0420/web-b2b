        ...
        return (
            <div className="">
                <button
                    ...
                    className={`group flex w-full items-center justify-between rounded-none py-2 pr-3.5 ${baseClasses} bg-transparent border-0`}
                    style={{
                        paddingLeft,
                        fontSize, // 动态字体大小
                    }}
    ...
    return (
        <div className="hidden lg:flex items-stretch">
            {navigationItems.map((item, index) => (
                <div key={item.name} className={`flex items-center ${index > 0 ? 'ml-10' : ''}`}>
                    {item.type === 'link' ? (
                        <Link
                            href={item.href}
                            className={`px-0 h-full flex items-center justify-center ${current === item.href ? 'text-mainColorNormal' : 'text-gray-900'} hover:text-mainColorNormal transition-colors duration-200 text-base/6 font-semibold`}
                            onClick={scrollToTop}
                        >
                            {lang[item.name]}
                        </Link>
                        ...
                        >
                            <Link
                                href={item.href}
                                className={`px-0 h-full ${current.indexOf(item.href) >= 0 ? 'text-mainColorNormal' : 'text-gray-900'} hover:text-mainColorNormal transition-colors duration-200 cursor-pointer h-full flex items-center gap-x-0.5 text-base/6 font-semibold`}
            ...
            >
                <div className="flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="-m-2.5 rounded-md p-2.5 text-gray-700 bg-transparent border-0"
                    >
        ...
        <>
            ...
            <div className="flex lg:hidden">
                <button
                    ...
                    className="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700 bg-transparent border-0"
                >
