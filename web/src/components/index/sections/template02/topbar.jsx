...
export default function TopBar({ sectionData }) {
    ...
    return (
        <div 
            className={`bg-mainColorNormal text-[#2F3B40] px-4 overflow-hidden transition-all duration-300 ease-in-out ${
                showTopBar ? 'py-2 max-h-20' : 'max-h-0 py-0'
            }`}
        >
            <div className="mx-auto max-w-7xl flex items-center text-white">
                    ...
                    <div className="hidden md:flex items-center space-x-3">
                        ...
                        {sectionData?.basicGlobal?.global_wechat?.trim().length > 0 && (
                            <Wechat
                                ...
                                iconSize="h-4 w-4"
                                colorStyle="text-white hover:text-white/75"
                            />
                        )}
                    </div>
                </div>
