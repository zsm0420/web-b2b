...
export default function TopBar({ sectionData }) {
    ...
    return (
        <div 
            className={`bg-mainColorNormal text-[#fff] px-4 overflow-hidden transition-all duration-300 ease-in-out ${
                showTopBar ? 'py-2 max-h-20' : 'max-h-0 py-0'
            }`}
            ...
            <div className="mx-auto max-w-7xl flex items-center">
                <div className="flex items-center space-x-4 text-sm">
                    <div className="flex items-center">
                        ...
                        <a href={`mailto:${sectionData['basicGlobal']['global_email']}`} className="">
                    ...
                    <div className="flex items-center">
                        ...
                        <a href={`tel:${sectionData['basicGlobal']['global_phone']}`} className="">
                ...
                <div className="flex-1 flex flex-row justify-end items-center">
                    <div className="hidden md:flex md:flex-row justify-end items-center space-x-3" style={{ position: 'relative', zIndex: 65 }}>
                        ...
                        {/* WeChat 组件 */}
                        {sectionData?.basicGlobal?.global_wechat?.trim().length > 0 && (
                            <Wechat
                                wechatId={sectionData['basicGlobal']['global_wechat']}
                                qrCodeImage={sectionData['basicGlobal']['global_wechat_qrcode']}
                                iconSize="h-4 w-4"
                                colorStyle="text-white hover:text-white/80 "
                            />
                        )}
