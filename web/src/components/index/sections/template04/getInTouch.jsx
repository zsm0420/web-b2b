...
export default function GetInTouch({contactData}) {
    ...
    return (
        <div className="bg-white py-16 lg:py-24">
            {/* 自定义 Alert Dialog */}
            {alertState.open && (
                <div className="fixed w-full h-full top-0 left-0 inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                    <div 
                        ref={alertRef}
                        ...
                        <div className="p-6">
                            <h3 
                                ...
                                className={`text-lg font-semibold mb-2 ${
                                    alertState.variant === 'destructive' ? 'text-red-600' : 'text-gray-900'
                                }`}
                            >
                                {alertState.title}
                            </h3>
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-14">
                    <div className="text-xl text-gray-900 mb-6 uppercase text-center">
                        ...
                        <span className="text-[#4e5866] ml-2">{lang.GetInTouch}</span>
                    </div>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 bg-white overflow-hidden border border-gray-100">
                        
                        {/* 左侧联系表单 */}
                        <div className="p-8 lg:p-12 relative">
                            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-mainColorNormal to-transparent"></div>
                            
                            <h3 className="text-xl font-semibold text-gray-900 mb-8 flex items-center">
                                <span className="w-8 h-8 flex items-center justify-center rounded-full bg-mainColorNormal text-white mr-3">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div>
                                    <input
                                        ...
                                        className="w-full px-4 py-3 border-b border-gray-200 focus:border-mainColorNormal focus:outline-none transition-colors duration-300 bg-transparent"
                                    />
                                </div>
                                ...
                                <div>
                                    <textarea
                                        ...
                                        rows="4"
                                        className="w-full px-4 py-3 border-b border-gray-200 focus:border-mainColorNormal focus:outline-none transition-colors duration-300 bg-transparent resize-none"
                                    ></textarea>
                                </div>
                                ...
                                <div>
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="mt-4 inline-flex items-center px-6 py-3 border border-mainColorNormal text-mainColorNormal hover:bg-mainColorNormal hover:text-white font-medium transition-colors duration-300 text-sm rounded-none"
                                    >
                        ...
                        {/* 右侧联系信息 */}
                        <div className="bg-gray-50 p-8 lg:p-12 border-t lg:border-t-0 lg:border-l border-gray-100 relative">
                            <div className="absolute top-0 right-0 w-full h-1 bg-gradient-to-l from-mainColorNormal to-transparent lg:w-1 lg:h-full lg:top-0 lg:right-0"></div>
                            <div className="h-full flex flex-col relative z-10">

                                <h3 className="text-xl font-semibold text-gray-900 mb-10 flex items-center">
                                    <span className="w-8 h-8 flex items-center justify-center rounded-full bg-mainColorNormal text-white mr-3">
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                                ...
                                <div className="space-y-10 mb-auto relative z-10">
                                    {/* 邮箱 */}
                                    <div className="flex">
                                        <div
                                            className="w-12 h-12 rounded-full bg-mainColorLight flex items-center justify-center mr-5 shrink-0">
                                ...
                                {/* 社交媒体 */}
                                <div className="mt-12 pt-8 border-t border-gray-200 relative z-20">
                                    <p className="text-gray-700 font-medium mb-5 uppercase tracking-wide text-sm">{lang.FollowUs}</p>
                                    <div className="flex space-x-5">
                                        ...
                                        {contactData.global_wechat?.length > 0 && (
                                            <Wechat
                                                ...
                                                colorStyle="text-[#09BB07] hover:opacity-80"
                                                iconSize="h-6 w-6"
                                            />
                                        )}
                                    </div>
