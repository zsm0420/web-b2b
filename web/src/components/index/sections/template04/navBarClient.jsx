        ...
        return (
            <div className="">
                ...
                >
                    ...
                    <ChevronDownIcon
                        aria-hidden="true"
                        className={`size-5 flex-none transition-transform duration-200 ${isOpen ? 'rotate-180' : ''}`}
                    />
                </button>
                <div className={`mt-2 space-y-2 transition-all duration-200 ${isOpen ? 'block' : 'hidden'}`}>
...
export function DesktopNav({navigationItems, current}) {
    ...
    return (
        <div className="pr-12 hidden lg:flex items-stretch">
...
export function MobileNav({sectionData, mobileMenuOpen, setMobileMenuOpen}) {
    ...
    return (
        <div className="fixed inset-0 z-[60] lg:hidden">
            ...
            <div 
                ref={menuRef}
                className="fixed inset-y-0 right-0 z-[60] w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 transform transition-transform duration-300"
            >
