                    ...
                    <div className="lg:w-[70%]">
                        <div
                            ...
                            <div className="p-6 lg:p-8">
                                {/* 标题信息和日期 */}
                                <h1 className="text-xl lg:text-3xl font-bold text-gray-900 mb-4">{detailData.title}</h1>
                                ...
                                <div className="relative w-full aspect-video mb-6 overflow-hidden">
                                    <Suspense fallback={<ImageSkeleton className="w-full h-72 md:h-96"/>}>
                                        <Image
                                            ...
                                            {recommendData.map(product => {
                                                ...
                                                return (
                                                    <Link href={`/product/${product.id}`} key={product.id}
                                                        ...
                                                        <div
                                                            className="w-24 h-24 bg-gray-50 overflow-hidden flex-shrink-0 relative border border-gray-100 group-hover:border-mainColorLight transition-colors">
                                                            <Suspense
