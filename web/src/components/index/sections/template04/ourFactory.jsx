...
export default function OurFactory({ companyImageData }) {
    ...
    return (
        <section className="pt-12 pb-20 bg-white">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    ...
                    <div className="mb-6">
                        <div className="flex justify-center mb-4">
                            <div className="inline-flex items-center border border-gray-200 rounded-full px-3 py-1">
                                <span className="w-3 h-3 bg-mainColorNormal rounded-full mr-3"></span>
                                <span className="uppercase text-[16px] text-gray-700">{lang.OurFactory}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
                    {dataList.map((item, index) => (
                        <div
                            key={index}
                            className="group overflow-hidden border border-gray-200 cursor-pointer"
            ...
            {modalOpen && (
                <div
                    className={`fixed w-full h-full top-0 left-0 inset-0 bg-black/80 backdrop-blur-sm z-[66] flex items-center justify-center p-4 transition-opacity duration-300 ${
